...
URL_FILE="envidatS3paths_future.txt"   # File containing the list of URLs to download
LOG_FILE="download_log_future.txt"     # Log file to record the download process
